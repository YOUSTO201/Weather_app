...
class _WeatherScreenState extends State<WeatherScreen>
  ...
  networkController.fetchWeather = _fetchWeatherData;
        ...
        child: Scaffold(
          ...
          body: Container(
            decoration: BoxDecoration(
              gradient: getWeatherGradient(weatherData),
            ),
            child: Column(
                          ...
                          ? Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    'Please Access your location Permission and Services to improve your app experience',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 18,
                                    ),
                                ...
                                ElevatedButton.icon(
                                  ...
                                  icon: Icon(Icons.my_location),
                                  label: Text('Access Location Services'),
                                ),
                                SizedBox(height: size.height * 0.03),
                                Padding(
                                  padding: EdgeInsets.only(
